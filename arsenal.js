...
(() => {
  const ARMOR = [
    ...
    { id:'servo-armor', name:'Серво-броня', ac:15, extraHands:1, rule:'Даёт одну дополнительную руку. Персонаж может использовать до трёх рук для оружия и снаряжения.' },
    ...
    { id:'terminator-armor', name:'Броня Терминатора', ac:19, rule:'Все проверки Ловкости совершаются с помехой. Броня считается оснащённой силовым полем.' },
  ];

  const FAMILY_RULES = {
    las: 'Критический провал при атаке этим оружием можно перебросить.',
    stub: 'После выстрела необходимо потратить бонусное действие, чтобы перезарядить оружие или дослать следующий патрон.',
    bolter: 'Критическое попадание срабатывает при результате 19–20. Порог критического урона на каждом кубике снижается на 1.',
    plasma: 'Можно перегреть оружие и удвоить урон. Если на d20 атаки выпало 5 или меньше, стрелок получает 10 урона.',
    melta: 'Дальность определяется огнемётным шаблоном, но атака направляется только в одну цель. Для этой атаки класс брони цели снижается на 2.',
  ...
  const WEAPONS = [
    ...
    { id:'heavy-stubber', family:'stub', group:'Пулевое', name:'Тяжёлый стаббер', damage:'3d6', hands:2, rule:'Перед стрельбой необходимо потратить действие, чтобы развернуть орудие.' },
    ...
    { id:'heavy-bolter', family:'bolter', group:'Болтерное', name:'Тяжёлый болтер', damage:'2d10', modifier:'strength', hands:2, rule:'Перед стрельбой необходимо потратить действие, чтобы развернуть орудие.' },
    ...
    { id:'grenade-launcher', group:'Взрывное', name:'Гранатомёт', damage:'Урон гранаты', hands:2, rule:'Позволяет выстрелить гранатой по цели, которую персонаж не видит.' },
    ...
    { id:'heretic-claws', group:'Врождённое', name:'Когти Еретика', damage:'2d4', modifier:'dexterity', hands:0, builtIn:true, allowedArchetypes:['heretic'], restriction:'Это врождённое оружие доступно только Еретику.', rule:'Когти являются частью рук Еретика, не занимают слоты рук и не могут быть сняты.' },
  ];
  ...
  const GEAR = [
    ...
    { id:'combat-servo-skull', group:'Механизмы', name:'Боевой сервочереп', hands:0, rule:'Считается несущим автоган. Для стрельбы совершает бросок атаки без модификаторов.' },
    ...
    { id:'loudspeaker', group:'Поддержка', name:'Громкоговоритель', hands:1, rule:'Снижает стоимость ультимейта для всей команды на 1 монету, но не ниже 1 монеты. Занимает одну руку.' },
    { id:'omnis-axe', group:'Механизмы', name:'Топор Омниссии', hands:1, rule:'Позволяет взаимодействовать с конструктами и машинами в базовом контакте. Проверка Интеллекта (СЛ 15) отключает простой конструкт или машину. Занимает одну руку.' },
    { id:'grenade', group:'Расходники', name:'Граната', hands:0, stackable:true, rule:'Наносит 4d6 урона всем существам в области шаблона, которые не прошли проверку Ловкости (СЛ 15). Цель атаки должна быть видна.' },
    { id:'psyker-staff', group:'Психо-снаряжение', name:'Посох псайкера', hands:1, allowedArchetypes:['psyker'], restriction:'Доступен только Псайкеру.', rule:'Действием позволяет накапливать силу Варпа, снижая сложность всех последующих проверок психосил на 2. Занимает одну руку.' },
    ...
    { id:'auspex', group:'Механизмы', name:'Ауспекс', hands:0, rule:'Позволяет атаковать скрытого противника, даже если персонаж его не видит.' },
  ];
